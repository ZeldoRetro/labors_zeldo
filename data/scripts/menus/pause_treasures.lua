--Inventory Menu: Assignables items and equipment items. This submenu shows the treasures 
...
local song_names = {
  ...
  "treasures/treasure_shadow_pearl",
  "treasures/treasure_demon_fossil",
  "treasures/treasure_goron_amber",
  "treasures/treasure_zora_crown",
  "treasures/treasure_draconian_scale",
  "treasures/treasure_pink_coral",
  "treasures/treasure_royal_ring",
