--Inventory Menu: Assignables items and equipment items. This submenu shows the songs
...
local inventory_background = sol.surface.create("menus/inventory_songs_background.png")
