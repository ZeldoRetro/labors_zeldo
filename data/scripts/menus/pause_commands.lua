...
local commands_background = sol.surface.create("menus/commands_background.png")
...
function commands_manager:new(game)
  ...
  function commands_menu:on_joypad_hat_moved(hat, direction8)
    ...
    local joypad_action = "hat " .. hat .. " " .. keys[direction8 / 2]
    set_command_joypad_binding(item, joypad_action)
    stop_customizing()
    return true
  end
  ...
  function commands_menu:on_draw(dst_surface)
    commands_background:draw(dst_surface)
