...
function pause_manager:create(game)
  ...
  local treasures_builder = require("scripts/menus/pause_treasures")
  local loots_builder = require("scripts/menus/pause_loots")
  local songs_builder = require("scripts/menus/pause_songs")
  ...
  function pause_menu:on_started()
    ...
    pause_submenus[submenus_order.quest_status] = quest_status_builder:new(game)
    pause_submenus[submenus_order.map] = map_builder:new(game)
    pause_submenus[submenus_order.treasures] = treasures_builder:new(game)
    pause_submenus[submenus_order.loots] = loots_builder:new(game)
    pause_submenus[submenus_order.songs] = songs_builder:new(game)
