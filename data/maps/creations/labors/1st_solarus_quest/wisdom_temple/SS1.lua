...
map:register_event("on_started", function(map, destination)
  ...
  if game:get_value("key_10015_4") then
    gislaine_1:set_enabled(true)
    gislaine_2:set_enabled(true)
    gislaine_3:set_enabled(true)
    gislaine_4:set_enabled(true)
  end
end)
