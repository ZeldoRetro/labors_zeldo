...
map:register_event("on_draw",function(map,dst_surface)
  ...
  if img_chara:is_enabled() then
    map:draw_visual(img_chara:get_sprite(), img_chara:get_position())
  end
end)
