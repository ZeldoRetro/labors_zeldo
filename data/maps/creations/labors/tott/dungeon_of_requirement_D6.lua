...
function tp_switch_next:on_activated()
  hero:teleport("creations/labors/tott/dungeon_of_requirement_D7","previous","immediate")
end

function tp_switch_previous:on_activated()
  hero:teleport("creations/labors/tott/dungeon_of_requirement_D5","next","immediate")
end