...
function enemy:on_created()
  ...
  self:create_sprite("enemies/boss/poe_big_blue")
...
function enemy:on_restarted()
  ...
  if life <= 6 then max_fire_created = 16
  elseif life > 6 and life <= 12 then max_fire_created = 12
  elseif life > 12 and life <= 18 then max_fire_created = 8
  end
...
function enemy:on_hurt()
  local x,y = enemy:get_map():get_entity("miniboss_spot_"..math.random(5)):get_position()
