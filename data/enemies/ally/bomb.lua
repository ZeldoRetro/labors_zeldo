...
function enemy:go(duration, height, angle, speed)
  ...
  enemy:bounce_go(duration, height, throwing_angle, speed, function()
    enemy:bounce()
  end)
...
function enemy:explode()
  ...
  local explosion = map:create_custom_entity({
    ...
    properties = {
      ...
      {key = "hurtable_type_3", value = "custom_entity"},
      {key = "hurtable_type_4", value = "door"},
      {key = "hurtable_type_5", value = "crystal"}
    }
  })
